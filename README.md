...
Functionality: **_Git Component inside a Camel route_**
...
Git clone the xbr_Git project into your workspace:

_from your bash shell:_

```bash
cd yourworkspacedirectory
git clone https://github.com/jammazwan/xbr_Git.git
cd xbr_Git
mvn install -DskipTests

```

You man now import xbr_Git into your IDE.
...
_Run XbrTest. Also see NOTES.md_
